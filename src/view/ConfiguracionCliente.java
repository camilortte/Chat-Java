 ...
 * @author camilortte
 */
public class ConfiguracionCliente extends javax.swing.JDialog {
     ...
     */
    public ConfiguracionCliente(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        this.setLocationRelativeTo(null);
        ventana=(VentanaCliente) parent;
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                ConfiguracionCliente dialog = new ConfiguracionCliente(new javax.swing.JFrame(), true);
